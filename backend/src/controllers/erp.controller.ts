...
export const timetableList = asyncHandler(async (req, res) =>
  res.json({
    success: true,
    data: await erp.listTimetableEntries(
      requireInstitution(req),
      actor(req),
      {
        dayOfWeek:
...
export const timetable = asyncHandler(async (req, res) =>
  res.status(201).json({
    success: true,
    data: await erp.createTimetableEntry(
      requireInstitution(req),
      actor(req),
      req.body
    ),
...
export const timetableUpdate = asyncHandler(async (req, res) =>
  res.json({
    success: true,
    data: await erp.updateTimetableEntry(
      requireInstitution(req),
      actor(req),
      req.params.id,
      req.body
...
export const timetableDelete = asyncHandler(async (req, res) =>
  res.json({
    success: true,
    data: await erp.deleteTimetableEntry(
      requireInstitution(req),
      actor(req),
      req.params.id
    ),
...
export const result = asyncHandler(async (req, res) =>
  res.status(200).json({
    success: true,
    data: await erp.upsertExamResult(
      requireInstitution(req),
      actor(req),
      req.body
    ),
...
export const invoiceList = asyncHandler(async (req, res) =>
  res.json({
    success: true,
    data: await erp.listFeeInvoices(
      requireInstitution(req),
      actor(req),
      {
        studentId:
...
export const invoiceUpdate = asyncHandler(async (req, res) =>
  res.json({
    success: true,
    data: await erp.updateFeeInvoice(
      requireInstitution(req),
      actor(req),
      req.params.id,
      req.body
...
export const invoiceDelete = asyncHandler(async (req, res) =>
  res.json({
    success: true,
    data: await erp.deleteFeeInvoice(
      requireInstitution(req),
      actor(req),
      req.params.id
    ),
...
export const parentLinkList = asyncHandler(async (req, res) =>
  res.json({
    success: true,
    data: await erp.listParentLinks(
      requireInstitution(req),
      actor(req),
      typeof req.query.studentId === "string"
        ? req.query.studentId
...
export const parentLinkDelete = asyncHandler(async (req, res) =>
  res.json({
    success: true,
    data: await erp.deleteParentLink(
      requireInstitution(req),
      actor(req),
      req.params.parentId,
